                        ...
                        <form method="POST" action="{{ route('register') }}" novalidate>
                            ...
                            <div class="mb-2">
                                ...
                                <div class="input-group input-group-merge @error('password') is-invalid @enderror" data-hs-validation-validate-class>
                                    <input type="password" class="js-toggle-password form-control" name="password" id="password" autocomplete="new-password" data-hs-toggle-password-options='{
                                        "target": "#new-target",
                            ...
                            <div class="mb-2">
                                ...
                                <div class="input-group input-group-merge @error('password_confirmation') is-invalid @enderror" data-hs-validation-validate-class>
                                    <input type="password" class="js-toggle-password form-control" name="password_confirmation" id="password-confirm" autocomplete="new-password" data-hs-toggle-password-options='{
