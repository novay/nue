...
class Role extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('nue.database.roles_table'));
    ...
    public function administrators(): BelongsToMany
    {
        ...
        $relatedModel = config('nue.database.users_model');
    ...
    {
        $pivotTable = config('nue.database.role_permissions_table');
    ...
    {
        $pivotTable = config('nue.database.role_menu_table');

        $relatedModel = config('nue.database.menu_model');
